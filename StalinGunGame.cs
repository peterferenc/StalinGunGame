...
namespace NightFish.StalinGunGame
{
    public class StalinGunGame : RocketPlugin
    {
        float EastWall = 50;
        float WestWall = -50;
        float NorthWall = 50;
        ...
        bool DisableStalinGunGame = false;
        ...
        Dictionary<ulong, int> StalinGunGameLevels = new Dictionary<ulong, int>();
        ...
        public void LoadTranslationDefaults()
        {
            ...
            DFTranslations.Add("StalinGunGame_DISABLED", new string[] { "Sorry, Gun Game is currently disabled or not running!", "FFEB04" });
            DFTranslations.Add("StalinGunGame_RUNNING", new string[] { "Gun Game is already running, use '/ggstop' to stop the round.", "FFEB04" });
            DFTranslations.Add("StalinGunGame_STOPPED", new string[] { "Gun Game is not already running, use '/ggstart' to start a round.", "FFEB04" });
            DFTranslations.Add("StalinGunGame_DEDICATED", new string[] { "Gun Game must be running in non-dedicated mode to use this command!", "FFEB04" });
        }
        ...
        public Color HexToColor(string hex)
        {
            ...
            {
                Rocket.Core.Logging.Logger.LogWarning("Invalid hex color: " + hex);
                return Color.white;
            }
        }
        ...
        {
            if (File.Exists(@"plugins\StalinGunGame\StalinGunGameConfig.xml"))
                File.Delete(@"plugins\StalinGunGame\StalinGunGameConfig.xml");
            XmlWriterSettings xset = new XmlWriterSettings();
            xset.Indent = true;
            xset.NewLineOnAttributes = true;

            using (XmlWriter writer = XmlWriter.Create(@"plugins\StalinGunGame\StalinGunGameConfig.xml", xset))
            {
                writer.WriteStartDocument();
                writer.WriteStartElement("StalinGunGameConfiguration");
        ...
        {
            if (File.Exists(@"plugins\StalinGunGame\StalinGunGameTranslations.xml"))
                File.Delete(@"plugins\StalinGunGame\StalinGunGameTranslations.xml");
            XmlWriterSettings xset = new XmlWriterSettings();
            xset.Indent = true;
            xset.NewLineOnAttributes = true;

            using (XmlWriter writer = XmlWriter.Create(@"plugins\StalinGunGame\StalinGunGameTranslations.xml", xset))
            {
                writer.WriteStartDocument();
                writer.WriteStartElement("StalinGunGameTranslations");
        ...
        public void LoadConfig()
        {
            ...
            else
            {
                ...
                using (XmlReader reader = XmlReader.Create(@"plugins\StalinGunGame\StalinGunGameConfig.xml"))
                {
                            ...
                            switch (reader.Name)
                            {
                                case "WestWall":
                                    if (reader.Read())
                                    {
                                        ...
                                        Rocket.Core.Logging.Logger.Log("West wall set to: " + reader.Value.Trim());
                                    }
                                    break;
                                case "EastWall":
                                    if (reader.Read())
                                    {
                                        ...
                                        Rocket.Core.Logging.Logger.Log("East wall set to: " + reader.Value.Trim());
                                    }
                                    break;
                                case "SouthWall":
                                    if (reader.Read())
                                    {
                                        ...
                                        Rocket.Core.Logging.Logger.Log("South wall set to: " + reader.Value.Trim());
                                    }
                                    break;
                                case "NorthWall":
                                    if (reader.Read())
                                    {
                                        ...
                                        Rocket.Core.Logging.Logger.Log("North wall set to: " + reader.Value.Trim());
                                    }
                                    break;
                                case "Weapon":
                                    if (reader.Read())
                                    {
                                        ...
                                        Rocket.Core.Logging.Logger.Log("Added weapon: " + reader.Value.Trim());
                                ...
                                case "TimeBetweenRounds":
                                    if (reader.Read())
                                    {
                                        Rocket.Core.Logging.Logger.Log("Time between rounds: " + reader.Value.Trim());
                                ...
                                case "WallStartY":
                                    if (reader.Read())
                                    {
                                        Rocket.Core.Logging.Logger.Log("Wall Y pos start: " + reader.Value.Trim());
                                ...
                                case "WallEndY":
                                    if (reader.Read())
                                    {
                                        Rocket.Core.Logging.Logger.Log("Wall Y pos end: " + reader.Value.Trim());
                                ...
                                case "DisableWall":
                                    if (reader.Read())
                                    {
                                        Rocket.Core.Logging.Logger.Log("Disable wall generation: " + reader.Value.Trim());
                                ...
                                case "WallBarricadeWidth":
                                    if (reader.Read())
                                    {
                                        Rocket.Core.Logging.Logger.Log("Wall barricade width: " + reader.Value.Trim());
                                ...
                                case "WallBarricadeHeight":
                                    if (reader.Read())
                                    {
                                        Rocket.Core.Logging.Logger.Log("Wall barricade height: " + reader.Value.Trim());
                                ...
                                case "WallBarricadeID":
                                    if (reader.Read())
                                    {
                                        Rocket.Core.Logging.Logger.Log("Wall barricade ID: " + reader.Value.Trim());
                                ...
                                case "DisableClear":
                                    if (reader.Read())
                                    {
                                        Rocket.Core.Logging.Logger.Log("Disable barricade/structure clearing: " + reader.Value.Trim());
                                ...
                                case "DisableUnstick":
                                    if (reader.Read())
                                    {
                                        Rocket.Core.Logging.Logger.Log("Disable unstick command: " + reader.Value.Trim());
                                ...
                                case "UnstickDelay":
                                    if (reader.Read())
                                    {
                                        Rocket.Core.Logging.Logger.Log("Unstick delay: " + reader.Value.Trim() + " seconds");
                                ...
                                case "UnstickCooldown":
                                    if (reader.Read())
                                    {
                                        Rocket.Core.Logging.Logger.Log("Unstick cooldown: " + reader.Value.Trim() + " seconds");
                                ...
                                case "UseCustomSpawnpoints":
                                    if (reader.Read())
                                    {
                                        Rocket.Core.Logging.Logger.Log("Use custom spawnpoints: " + reader.Value.Trim());
                                ...
                                case "Z":
                                    if (reader.Read())
                                    {
                                        ...
                                        Rocket.Core.Logging.Logger.Log("Custom spawn: " + CurrentSpawnName + " at: X:" + CurrentSpawnX + ", Y:" + CurrentSpawnY + ", Z:" + Convert.ToDouble(reader.Value.Trim()));
                                        CurrentSpawnName = "";
                                        CurrentSpawnX = 0;
                                        CurrentSpawnY = 0;
                                    }
                                ...
                                case "UseRandomOrder":
                                    if (reader.Read())
                                    {
                                        Rocket.Core.Logging.Logger.Log("Random Weapon Order: " + Convert.ToBoolean(reader.Value.Trim()));
                ...
                {
                    Rocket.Core.Logging.Logger.LogError("East wall must be bigger than West wall! Please fix this error to continue!");
                    error = true;
                }
                if (NorthWall <= SouthWall)
                {
                    Rocket.Core.Logging.Logger.LogError("North wall must be bigger than South wall! Please fix this error to continue!");
                    error = true;
                }
            }
            ...
            if (UseCustomSpawns)
            {
                ...
                {
                    Rocket.Core.Logging.Logger.LogError("No custom spawn points set! Defaulting back to random spawns...");
        ...
        {
            if (File.Exists(@"plugins\StalinGunGame\StalinGunGame.en.translation.xml"))
                File.Delete(@"plugins\StalinGunGame\StalinGunGame.en.translation.xml");
            if (!File.Exists(@"plugins\StalinGunGame\StalinGunGameTranslations.xml"))
            {
                SaveTranslation();
            }
            ...
            {
                using (XmlReader reader = XmlReader.Create(@"plugins\StalinGunGame\StalinGunGameTranslations.xml"))
                {
                    string CurrentKey = "";
                    string CurrentText = "";
                            ...
                            switch (reader.Name)
                            {
                                ...
                                case "Color":
                                    if (reader.Read())
                                    {
                                        ...
                                        {
                                            c = HexToColor(col);
                                            Rocket.Core.Logging.Logger.Log("Translation loaded: " + CurrentKey + " with color: " + col);
                                            addTra(CurrentKey, CurrentText, c);
                                        }
                                        else
                                        {
                                            Rocket.Core.Logging.Logger.LogError("Invalid hex color for: " + CurrentKey);
                                        }
                                    }
                                    break;
                            }
        ...
        public string tra(string ID, params object[] Parameters)
        {
            ...
            {
                Rocket.Core.Logging.Logger.LogError(ID + " not found in translation!");
                return "";
            }
        }
        ...
        public Color col(string ID)
        {
            ...
            {
                Rocket.Core.Logging.Logger.LogError("Error parsing color: " + DFTranslations[ID][1] + " For: " + ID);
                return Color.green;
            }
        }
        ...
        protected override void Load()
        {
            ...
            foreach (SteamPlayer sp in Provider.clients)
            {
                ...
                StalinGunGameLevels.Add(player.CSteamID.m_SteamID, 0);
        ...
        public void PlayerDeath(UnturnedPlayer player, EDeathCause cause, ELimb limb, CSteamID murderer)
        {
            ...
            if (killedByPlayer)
            {
                try
                {
                    ...
                    try
                    {
                        pastLevel = StalinGunGameLevels[killer.CSteamID.m_SteamID];
                    }
                    catch { }
                    StalinGunGameLevels.Remove(killer.CSteamID.m_SteamID);
                    StalinGunGameLevels.Add(killer.CSteamID.m_SteamID, pastLevel + 1);
                    ...
                    if (cause == EDeathCause.MELEE)
                    {
                        ...
                        try
                        {
                            pastDeathLevel = StalinGunGameLevels[player.CSteamID.m_SteamID];
                        }
                        catch { }
                        if (pastLevel > 0)
                        {
                            StalinGunGameLevels.Remove(player.CSteamID.m_SteamID);
                            StalinGunGameLevels.Add(player.CSteamID.m_SteamID, pastDeathLevel - 1);
                        }
                        int playerLevel = 0;
                        try
                        {
                            playerLevel = StalinGunGameLevels[player.CSteamID.m_SteamID];
                        }
                        catch
                        { }
                    }
        ...
        public void RebuildWall()
        {
            ...
            if (!disableClearing)
            {
                ...
                Rocket.Core.Logging.Logger.LogWarning(tra("BARRIC_CLR"));
                Rocket.Core.Logging.Logger.LogWarning(tra("STRUCT_CLR"));
            }
            if (!disableWallGen)
            {
                ...
                Rocket.Core.Logging.Logger.LogWarning(tra("WALL_REBUILD"));
            }
            else
            {
                Rocket.Core.Logging.Logger.LogWarning(tra("WALL_REBUILD_DISABLED"));
            }
        }
        ...
        public void ResetGame()
        {
            ...
            Rocket.Core.Logging.Logger.LogWarning(tra("GAME_RESET_LOG"));
            StalinGunGameLevels.Clear();
            killstreak.Clear();
            OP.Clear();
            Rocket.Core.Logging.Logger.LogWarning(tra("LVL_RESET"));
            foreach (SteamPlayer sp in Provider.clients)
            {
                try
                {
            ...
            Rocket.Core.Logging.Logger.LogWarning(tra("VEH_KICK"));
            Rocket.Core.Logging.Logger.LogWarning(tra("ITEM_CLR"));
            RebuildWall();
            VehicleManager.askVehicleDestroyAll();
            Rocket.Core.Logging.Logger.LogWarning(tra("VEH_CLR"));
            GenerateWeaponList();
                ...
                foreach (SteamPlayer sp in Provider.clients)
                {
                    ...
                    if (!GameOver)
                    {
                        ...
                        else
                        {
                            ...
                            {
                                Rocket.Core.Logging.Logger.Log(tra("INV_ERR", player.CharacterName, e.Message));
                            }
                        }
                    }
                    try
            ...
            if ((DateTime.Now - lastBorderCheck).TotalSeconds > 0.2)
            {
                ...
                foreach (SteamPlayer sp in Provider.clients)
                {
                    try
                    {
                        ...
                        if (!StalinGunGameLevels.ContainsKey(player.CSteamID.m_SteamID))
                        {
                            StalinGunGameLevels.Add(player.CSteamID.m_SteamID, 0);
                        }

                        int PlayerLevel = StalinGunGameLevels[player.CSteamID.m_SteamID];
                        int index = 0;
                        int LevelGun = 0;
        ...
        {
            if (DisableStalinGunGame)
            {
                UnturnedChat.Say(caller, tra("StalinGunGame_DISABLED"), col("StalinGunGame_DISABLED"));
                return;
            }
        ...
        public void ExecuteCommandL(IRocketPlayer caller, string[] parameters)
        {
            ...
            try
            {
                pastLevel = StalinGunGameLevels[player.CSteamID.m_SteamID];
            }
            catch { }
            StalinGunGameLevels.Remove(player.CSteamID.m_SteamID);
            if (pastLevel != 0)
                StalinGunGameLevels.Add(player.CSteamID.m_SteamID, pastLevel - 1);
        }
        ...
        [RocketCommand("reset", "Reset the StalinGunGame server", "", AllowedCaller.Both)] //resets the gun game
        ...
        [RocketCommand("StalinGunGamestart", "Starts a non-dedicated Gun Game round", "", AllowedCaller.Both)] //Starts a non-dedicated Gun Game round
        public void ExecuteCommandStalinGunGamestart(IRocketPlayer caller, string[] parameters)
        {
            if (DedicatedMode)
            {
                UnturnedChat.Say(caller, tra("StalinGunGame_DEDICATED"), col("StalinGunGame_DEDICATED"));
                return;
            }

            if (!DisableStalinGunGame)
            {
                UnturnedChat.Say(caller, tra("StalinGunGame_RUNNING"), col("StalinGunGame_RUNNING"));
                return;
            }
            ...
            foreach (SteamPlayer sp in Provider.clients)
            {
                ...
                {
                    Rocket.Core.Logging.Logger.LogError("Error enforcing start task for: " + sp.playerID + " Error: " + ex.Message);
                }
            }
        ...
        [RocketCommand("StalinGunGamestop", "Stop a non-dedicated Gun Game round", "", AllowedCaller.Both)] //Stops a non-dedicated Gun Game round
        public void ExecuteCommandStalinGunGamestop(IRocketPlayer caller, string[] parameters)
        {
            if (DedicatedMode)
            {
                UnturnedChat.Say(caller, tra("StalinGunGame_DEDICATED"), col("StalinGunGame_DEDICATED"));
            ...
            if (DisableStalinGunGame)
            {
                UnturnedChat.Say(caller, tra("StalinGunGame_STOPPED"), col("StalinGunGame_STOPPED"));
                return;
            }
            ...
            foreach (SteamPlayer sp in Provider.clients)
            {
                ...
                {
                    Rocket.Core.Logging.Logger.LogError("Error enforcing stop task for: " + sp.playerID + " Error: " + ex.Message);
                }
            }
    ...
    static class RandomExtensions
    {
        public static void Shuffle<T>(this IList<T> list)
        {
            ...
            {
                Rocket.Core.Logging.Logger.LogError("Error while shuffling array: " + ex.Message);
            }
        }
    }
}
